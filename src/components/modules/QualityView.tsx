    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
        ...
        <div className="glass-card p-5 space-y-1">
          ...
          <div className="text-3xl font-extrabold text-[var(--accent)] font-mono">{quality.testCoveragePercent}%</div>
      ...
      <div className="glass-card p-6 space-y-4">
        ...
        <div className="space-y-3 text-xs">
          {quality.qualityGates.map((qg) => (
            <div key={qg.id} className="p-4 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3">
