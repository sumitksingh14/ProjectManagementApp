...
for (const file of files) {
  ...
  // Also fix ISS-59 and others where we use `gridTemplateColumns: "repeat(3, 1fr)"` but we might want it to match or the spacing inside the hero banner to match Dashboard.
